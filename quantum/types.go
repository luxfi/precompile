...
// Corona (lattice-based threshold) and hybrid BLS+PQ signatures.
package quantum
...
type CoronaPublicKey struct {
	...
	Parameters   CoronaParams
}

// CoronaParams represents Corona security parameters
...
// CoronaSignature represents a Corona threshold signature
