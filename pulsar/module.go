...
func init() {
	if err := modules.RegisterModule(modules.Module{
		ConfigKey:    ConfigKey,
		Address:      ContractPulsarVerifyAddress,
		Contract:     PulsarVerifyPrecompile,
...
// Config is the precompileconfig.Config for the Pulsar (Module-LWE
// threshold FIPS 204 byte-equal) verify precompile.
type Config struct {
