...
// Config is the precompileconfig.Config for the HQC KEM encapsulation
// precompile. Mirrors the shape used by the rest of the PQCrypto block.
type Config struct {
