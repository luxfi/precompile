...
const ConfigKey = "magnetarVerify"
...
// Config is the precompileconfig.Config for the Magnetar (public-DKG
// MPC threshold SLH-DSA, FIPS 205 byte-equal) verify precompile.
type Config struct {
